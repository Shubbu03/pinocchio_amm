...
use amm::instructions::Initialize;
use amm::states::{to_bytes, MyState};
use solana_sdk::rent::Rent;
use solana_sdk::sysvar::Sysvar;

pub const PROGRAM: Pubkey = pubkey!("42QPYg5DLqEJf5rsJqcc2ciDoNNXXGTRne9VaWYevFEv");
...
pub fn mollusk() -> Mollusk {
    let mollusk = Mollusk::new(&PROGRAM, "target/deploy/amm");
    mollusk
}
